...
public protocol SwipeNavigationControllerDelegate: class {
    ...
    func swipeNavigationController(_ controller: SwipeNavigationController, willShowEmbeddedViewForPosition position: SwipePosition)
    ...
    ///   - controller: Swipe navigation controller
    ///   - position: New position
    func swipeNavigationController(_ controller: SwipeNavigationController, didShowEmbeddedViewForPosition position: SwipePosition)
}
...
open class SwipeNavigationController: UIViewController {
    ...
    // MARK: - Containers
    open func showEmbeddedView(position: SwipePosition, animationDuration: Double = 0.2) {
    ...
    open func isContainerActive(position: SwipePosition) -> Bool {
        let targetOffset: CGVector
        switch position {
        case .center:
            targetOffset = centerContainerOffset
    ...
    // Append embedded view to container view's view hierachy
    func addEmbeddedViewController(_ viewController: UIViewController, previousViewController: UIViewController?, position: SwipePosition) {
    ...
    func alignCenterXConstraint(forItem item: UIView, toItem: UIView, position: SwipePosition) -> NSLayoutConstraint {
    ...
    func alignCenterYConstraint(forItem item: UIView, toItem: UIView, position: SwipePosition) -> NSLayoutConstraint {
